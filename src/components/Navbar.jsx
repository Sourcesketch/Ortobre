...
const Navbar = ({ userName, dashboardName, onLogout }) => {
  ...
  return (
    ...
    <nav className="flex justify-between items-center bg-gray-800 text-white p-4 sticky top-0">
      ...
      <div className="text-xl font-bold flex items-center gap-2 md:ml-0 ml-13">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button
            onClick={onLogout}
            className="hidden md:flex items-center px-3 py-2 rounded-md text-sm font-medium text-destructive hover:bg-destructive/10 transition-colors duration-200"
          >
