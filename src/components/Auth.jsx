...
//     try {
//       if (isSignup) {
//         // Signup using email and password; store extra fields in user_metadata.
//         const { data, error } = await supabase.auth.signUp({
//           email,
//           password,
//           options: {
//             data: { username, name, surname, phone, role: 'user' }
//           }
//         });
//         if (error) {
...
//         phone: `+${phone}`, // Ensure phone number includes country code
//       });
...
//         setIsPhoneLogin(true); // Show OTP input field
//       }
//     } finally {
//       setIsLoading(false);
//     }
...
//   // Listen for auth state changes to save social login user data
//   useEffect(() => {
